...
Здесь необходимо сделать замечание, что это лишь примерное классификационное разграничение. Естественно, что разметка должна проходить классификационными масками.
